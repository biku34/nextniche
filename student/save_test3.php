...
// Ensure all answers are set and store only the numerical value (0-5)
$answers = [];
for ($i = 1; $i <= 5; $i++) {
...
$check_query = "SELECT id FROM who5_assessment WHERE user_id = ?";
...
$query = "INSERT INTO who5_assessment (user_id, q1, q2, q3, q4, q5) VALUES (?, ?, ?, ?, ?, ?)";
