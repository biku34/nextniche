...
// Ensure all answers are set and store only the numerical value (0-1 for Yes/No)
$answers = [];
for ($i = 1; $i <= 4; $i++) {
...
$check_query = "SELECT id FROM cage_assessment WHERE user_id = ?";
...
$query = "INSERT INTO cage_assessment (user_id, q1, q2, q3, q4) VALUES (?, ?, ?, ?, ?)";
