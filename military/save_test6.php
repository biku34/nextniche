...
// Ensure all answers are set and store only the numerical value (0-3)
$answers = [];
for ($i = 1; $i <= 9; $i++) {
...
$check_query = "SELECT id FROM phq9_assessment WHERE user_id = ?";
...
$query = "INSERT INTO phq9_assessment (user_id, q1, q2, q3, q4, q5, q6, q7, q8, q9) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
